...
2026-07-22 | feat | server/api | partial | 2026-07/20260722-151259-task-comment-tools.md | 태스크 댓글(Mention) MCP 도구 4종 추가 — list/add/update/delete_task_comment, @멘션 username 해석·본문 선두 주입, html_to_text 평문 변환, 본인만 수정·삭제(403→ValueError) (v0.2.5)
